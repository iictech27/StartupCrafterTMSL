        ...
        <div className="bg-white shadow-md">
            <div className="container mx-auto px-4 py-4 flex justify-between items-center">
                ...
                <div className="hidden lg:flex lg:items-center lg:space-x-4">
                    ...
                    {/* <Link to="/login">
                        <button className="btn bg-[#a855f7] text-white border-0">Log In</button>
                    </Link> */}
                </div>
            </div>
            ...
            {isOpen && (
                <div className="lg:hidden">
                    <div className="px-4 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        {/* <Link to="/login" onClick={toggleMenu} className="block py-2 text-black">
                            <button className="w-full mt-3 bg-[#a855f7] text-white py-2 rounded-md text-center">Log In</button>
                        </Link> */}
                    </div>
                </div>
            )}
